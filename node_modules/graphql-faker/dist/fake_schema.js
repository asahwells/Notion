...
const fakeTypeResolver = async (value, context, info, abstractType) => {
...
exports.fakeTypeResolver = fakeTypeResolver;
const fakeFieldResolver = async (source, args, context, info) => {
    ...
    function fakeValueOfType(type) {
        ...
        const valueCB = getExampleValueCB(fieldDef) ||
...
exports.fakeFieldResolver = fakeFieldResolver;
